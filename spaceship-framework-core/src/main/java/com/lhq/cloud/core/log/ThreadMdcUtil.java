...
public class ThreadMdcUtil {
	...
	public static void setTraceIdIfAbsent() {
		if (MDC.get(LogConstants.LOG_TRACE_ID) == null) {
			MDC.put(LogConstants.LOG_TRACE_ID, TraceLogUtils.getTraceId());
		}
	}
	...
	public static class ThreadPoolTaskExecutorMdcWrapper extends ThreadPoolTaskExecutor {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 3005407717074806681L;
